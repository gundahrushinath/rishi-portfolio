...
import BlurFade from "@/components/portfolio/magicui/blur-fade";
import BlurFadeText from "@/components/portfolio/magicui/blur-fade-text";
...
export default function Page() {
  return (
    <div className="max-w-4xl mx-auto py-12 sm:py-24">
      ...
      <main className="flex items-center justify-center flex-col min-h-dvh space-y-10">
        <section id="hero">
